...
<p align="center"> <a href="README_JP.md"> Japanese </a> </p>
...
| 内鬼 | 船员 | 中立 | 其他 |
| ---- | ---- | ---- | ---- |
| [嗜血杀手](#连环杀手) | [占卜师](#占卜师) | [狐妖](#狐妖) |  |
| [邪恶黑客（由tomarai制作）](#邪恶黑客) | [幻视者](#幻视者) | [背德者](#背德者) |
| [绝境者](#最后一个内鬼) | [福尔摩斯](#福尔摩斯) | [薛定谔的猫](#薛定谔的猫) |
| [设陷者](#设陷者) | |  |
...
## 悠悠球
### **阵营：内鬼**
“悠悠球”是一名内鬼，他拥有标记一个位置的能力，随后瞬移（传送）到该位置的能力。

在第一次瞬移之后，“悠悠球”在自动瞬移回第一次瞬移的起始点之前，有一段固定时长（可设置）的时间来做任何他想做的事情。

每次瞬移都会留下一个透明度可设置的残影。这个残影很难被看到。

根据设置情况，“悠悠球”或许还能使用移动管理面板。

**注意：**
- 第一次跳跃目标的标记位置仅对“悠悠球”和幽灵显示。
- 第一次瞬移的残影（几乎）会一直留存，直到“悠悠球”返回。
- 第二次瞬移（返回）的残影会留存5秒钟。
...
<!--### 鹈鹕
行动阶段鹈鹕可以吞噬玩家，如果在进入会议前被其他玩家击杀，则该轮被吞噬的玩家会在鹈鹕位置复活。
...
| 选项名 | 说明 |
| ---- | ---- |
| 鹈鹕可以使用管道 | 开启后鹈鹕拥有通风管技能 |
| 鹈鹕吞噬技能冷却 | 设置鹈鹕吞噬技能的冷却时间 |
| 第二次吞噬技能冷却 | 鹈鹕每回合的第二次及之后的吞噬冷却会变短，进入会议后重置 |-->
...
# Changelog
<details>
  <summary>点击显示更新日志(TOR本家-机翻)</summary>
...
## 迷你船员
### **阵营：船员或内鬼**
迷你船员可能是船员（概率67%），也可能是内鬼（概率33%）。小跟班的职业模型更小，因此游戏中所有人都能看到。小跟班在18秒前无法被击杀，但可以被投票出局。
 - **内鬼迷你船员**：
...
**注意**：
 - 如果警长在小跟班完全长大前试图击杀它，警长会死亡，无论迷你船员是船员还是内鬼。
 - 警长只能在小跟班完全长大后，才能击杀内鬼迷你船员。
...
## 交换师
### **阵营：船员或中立**
交换师可以夺取另一名船员的职业，被交换的玩家将变成普通船员。交换操作总是在下一次会议结束、玩家被流放前执行。目标需在本轮选定。即使交换师或目标在会议前死亡，交换仍会执行。与内鬼或中立职业交换职业会失败，且交换师会在下一次会议后自杀（不会留下尸体）。交换师旨在拯救即将离开游戏的职业，例如夺取已被内鬼知晓的警长或医生职业。这对抹除者尤其有效，但也让抹除者有机会模仿变换者。与交换师的**特殊互动**在各自职业章节中有说明。

中立版的交换师，即连环交换师，能够从任何玩家身上窃取职业，无论其阵营。被交换的玩家随后继承连环交换师的职业，并且必须再去窃取另一名玩家的职业。在游戏结束时仍持有连环交换师职业的玩家自动失败。

**注意**：
 - 交换师的交换操作总是在清除操作之前触发（因此，根据抹除者清除的对象，要么交换师的新职业被清除，要么交换师保护了目标的职业）。
 - 如果交换师夺取一个职业，其新技能的冷却时间将从该技能的最大冷却时间开始。
 - 一次性使用的能力（例如保护一名玩家或工程师修复破坏）在游戏中只能由一名玩家使用（即交换师只能在之前的玩家未使用该能力时才能使用）。

### 游戏选项
| 名称                     | 描述 |
| ------------------------ | :--: |
| 交换师生成几率 | - |
| 交换师交换副职业 | 设置恋人关系和/或医生护盾是否会随变换转移 |
