    ...
    public static void createButtonsPostfix(HudManager __instance)
    {
        ...
        engineerRepairButton = new CustomButton(
            () =>
            {
                ...
                MessageWriter usedRepairWriter = AmongUsClient.Instance.StartRpcImmediately(
                    PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EngineerUsedRepair, SendOption.Reliable);
                ...
                foreach (PlayerTask task in PlayerControl.LocalPlayer.myTasks)
                    if (task.TaskType == TaskTypes.FixLights)
                    {
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                            PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EngineerFixLights, SendOption.Reliable);
                    ...
                    {
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                            PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EngineerFixSubmergedOxygen,
                            SendOption.Reliable);
                        AmongUsClient.Instance.FinishRpcImmediately(writer);
            ...
            () =>
            {
                return Engineer.engineer != null && Engineer.engineer == PlayerControl.LocalPlayer &&
                       Engineer.remainingFixes > 0 && PlayerControl.LocalPlayer.isAlive();
            },
            () =>
            {
        ...
        janitorCleanButton = new CustomButton(
            () =>
            {
                foreach (Collider2D collider2D in Physics2D.OverlapCircleAll(
                             PlayerControl.LocalPlayer.GetTruePosition(), PlayerControl.LocalPlayer.MaxReportDistance,
                    ...
                    if (collider2D.tag == "DeadBody")
                    {
                        ...
                        if (component && !component.Reported)
                        {
                                    ...
                                    Constants.ShipAndObjectsMask, false))
                            {
                                ...
                                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                                    PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CleanBody, SendOption.Reliable);
        ...
        evilHackerCreatesMadmateButton = new CustomButton(
            () =>
            {
                 ...
                 */
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                    (byte)CustomRPC.EvilHackerCreatesMadmate, SendOption.Reliable);
        ...
        hackerAdminTableButton = new CustomButton(
            ...
            {
                return Hacker.hacker != null && Hacker.hacker == PlayerControl.LocalPlayer &&
                       TORMapOptions.couldUseAdmin && PlayerControl.LocalPlayer.isAlive();
            },
            () =>
            {
                if (hackerAdminTableChargesText != null)
                    hackerAdminTableChargesText.text = hackerVitalsChargesText.text =
                        string.Format(ModTranslation.getString("hackerChargesText"), Hacker.chargesAdminTable,
                            Hacker.toolsNumber);
                return Hacker.chargesAdminTable > 0 && TORMapOptions.canUseAdmin;
                ;
            },
            () =>
            {
        ...
        hackerVitalsButton = new CustomButton(
            () =>
            {
                if (!Helpers.isMira() && !Helpers.isFungle())
                {
                    ...
                    {
                        SystemConsole e = Object.FindObjectsOfType<SystemConsole>()
            ...
            {
                return Hacker.hacker != null && Hacker.hacker == PlayerControl.LocalPlayer &&
                       TORMapOptions.couldUseVitals && PlayerControl.LocalPlayer.isAlive() &&
            ...
            () =>
            {
                if (hackerVitalsChargesText != null)
                    hackerVitalsChargesText.text = string.Format(ModTranslation.getString("hackerChargesText"),
                        Hacker.chargesVitals, Hacker.toolsNumber);
                ...
                return Hacker.chargesVitals > 0 && TORMapOptions.canUseVitals;
            },
            () =>
            {
        ...
        trackerTrackCorpsesButton = new CustomButton(
            ...
            {
                return Tracker.tracker != null && Tracker.tracker == PlayerControl.LocalPlayer &&
                       PlayerControl.LocalPlayer.isAlive() && Tracker.canTrackCorpses;
            },
            () => { return PlayerControl.LocalPlayer.CanMove; },
            () =>
            {
            ...
            () =>
            {
                ...
                if (murder == MurderAttemptResult.PerformKill)
                {
                    ...
                    else
                    {
                        ...
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                            PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.VampireSetBitten, SendOption.Reliable);
        ...
        garlicButton = new CustomButton(
            ...
            () =>
            {
                return !Vampire.localPlacedGarlic && PlayerControl.LocalPlayer.isAlive() && Vampire.garlicsActive &&
        ...
        jackalSidekickButton = new CustomButton(
            ...
            () =>
            {
                return Jackal.canCreateSidekick && Jackal.jackal != null &&
                       Jackal.jackal == PlayerControl.LocalPlayer && PlayerControl.LocalPlayer.isAlive();
            },
            () =>
            {
        ...
        sidekickKillButton = new CustomButton(
            ...
            () =>
            {
                return Sidekick.canKill && Sidekick.sidekick != null &&
                       Sidekick.sidekick == PlayerControl.LocalPlayer && PlayerControl.LocalPlayer.isAlive();
            },
        ...
        placeJackInTheBoxButton = new CustomButton(
            ...
            () =>
            {
                return Trickster.trickster != null && Trickster.trickster == PlayerControl.LocalPlayer &&
                       PlayerControl.LocalPlayer.isAlive() && !JackInTheBox.hasJackInTheBoxLimitReached();
            },
        ...
        warlockCurseButton = new CustomButton(
            () =>
            {
                ...
                {
                    MurderAttemptResult murder = Helpers.checkMuderAttemptAndKill(Warlock.warlock,
                        Warlock.curseVictimTarget, showAnimation: false);
        ...
        securityGuardButton = new CustomButton(
            () =>
            {
                ...
                else if (!Helpers.isMira() && !Helpers.isFungle() && TORMapOptions.couldUseCameras &&
                         !SubmergedCompatibility.isSubmerged())
                {
            ...
            () =>
            {
                return SecurityGuard.securityGuard != null &&
                       ...
                       PlayerControl.LocalPlayer.isAlive() && SecurityGuard.remainingScrews >=
            ...
            () =>
            {
                ...
                if (securityGuardButtonScrewsText != null)
                    securityGuardButtonScrewsText.text = string.Format(ModTranslation.getString("securityGuardScrews"),
                        SecurityGuard.remainingScrews);
                ...
                return !Helpers.isMira() && !Helpers.isFungle() && SubmergedCompatibility.isSubmerged() &&
                       TORMapOptions.couldUseCameras && SecurityGuard.remainingScrews >= SecurityGuard.camPrice &&
                       PlayerControl.LocalPlayer.CanMove;
            },
            () => { securityGuardButton.Timer = securityGuardButton.MaxTimer; },
        ...
        securityGuardCamButton = new CustomButton(
            () =>
            {
                if (!Helpers.isMira())
                {
                    ...
                    {
                        byte mapId = GameOptionsManager.Instance.currentNormalGameOptions.MapId;
                        SystemConsole e = Object.FindObjectsOfType<SystemConsole>().FirstOrDefault(x =>
            ...
            () =>
            {
                if (securityGuardChargesText != null)
                    securityGuardChargesText.text = securityGuardChargesText.text =
                        string.Format(ModTranslation.getString("hackerChargesText"), SecurityGuard.charges,
                            SecurityGuard.maxCharges);
        ...
        arsonistButton = new CustomButton(
            () =>
            {
                if (Arsonist.currentTarget != null) Arsonist.douseTarget = Arsonist.currentTarget;
            },
            () =>
            {
                return Arsonist.arsonist != null && Arsonist.arsonist == PlayerControl.LocalPlayer &&
                       !Arsonist.dousedEveryone && PlayerControl.LocalPlayer.isAlive();
            },
            () =>
            {
            ...
            () =>
            {
                ...
                {
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                        (byte)CustomRPC.ArsonistDouse, SendOption.Reliable);
            ...
            () =>
            {
                if (Arsonist.dousedEveryone)
                {
                    MessageWriter winWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.ArsonistWin, SendOption.Reliable);
        ...
        vultureEatButton = new CustomButton(
            () =>
            {
                    ...
                    if (collider2D.tag == "DeadBody")
                    {
                        ...
                        if (component && !component.Reported)
                        {
                                    ...
                                    Constants.ShipAndObjectsMask, false))
                            {
                                ...
                                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                                    PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.VultureEat, SendOption.Reliable);
                                writer.Write(playerInfo.PlayerId);
                                AmongUsClient.Instance.FinishRpcImmediately(writer);
                ...
                {
                    MessageWriter winWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.VultureWin, SendOption.Reliable);
                    AmongUsClient.Instance.FinishRpcImmediately(winWriter);
            ...
            () =>
            {
                if (vultureNumCorpsesText != null)
                    vultureNumCorpsesText.text = string.Format(ModTranslation.getString("vultureCorpses"),
        ...
        vultureNumCorpsesText = GameObject.Instantiate(vultureEatButton.actionButton.cooldownTimerText,
            vultureEatButton.actionButton.cooldownTimerText.transform.parent);
        ...
        mediumButton = new CustomButton(
            ...
            () =>
            {
                ...
                if (randomNumber == 0)
                    msg = string.Format(ModTranslation.getString("mediumQuestion1"),
                        RoleInfo.GetRolesString(Medium.target.player, false, includeHidden: true)) + name;
                else if (randomNumber == 1)
                    msg = string.Format(ModTranslation.getString("mediumQuestion2"), typeOfColor) + name;
                else if (randomNumber == 2)
                    msg = string.Format(ModTranslation.getString("mediumQuestion3"),
                        Math.Round(timeSinceDeath / 1000)) + name;
                else
                    msg = string.Format(ModTranslation.getString("mediumQuestion4"),
                        RoleInfo.GetRolesString(Medium.target.killerIfExisting, false, includeHidden: true)) + name;
                ; // Excludes mini
        ...
        pursuerButton = new CustomButton(
            ...
            () =>
            {
                if (pursuerButtonBlanksText != null)
                    pursuerButtonBlanksText.text = string.Format(ModTranslation.getString("pursuerBlanks"),
                        Pursuer.blanksNumber - Pursuer.blanks);
        ...
        witchSpellButton = new CustomButton(
            () =>
            {
                if (Witch.currentTarget != null) Witch.spellCastingTarget = Witch.currentTarget;
            },
            () =>
            {
        ...
        assassinButton = new CustomButton(
            () =>
            {
                if (Assassin.assassinMarked != null)
                {
                    ...
                    if (attempt == MurderAttemptResult.PerformKill)
                    {
                        ...
                        MessageWriter writer = AmongUsClient.Instance.StartRpc(PlayerControl.LocalPlayer.NetId,
                            (byte)CustomRPC.PlaceAssassinTrace);
                        writer.WriteBytesAndSize(buff);
                        writer.EndMessage();
                        ...
                        RPCProcedure.uncheckedMurderPlayer(PlayerControl.LocalPlayer.PlayerId,
                            Assassin.assassinMarked.PlayerId, byte.MaxValue);
                        ...
                        MessageWriter writer3 = AmongUsClient.Instance.StartRpc(PlayerControl.LocalPlayer.NetId,
                            (byte)CustomRPC.PlaceAssassinTrace);
                    ...
                    else if (attempt == MurderAttemptResult.SuppressKill) assassinButton.Timer = 0f;
            ...
            () =>
            {
                return Assassin.assassin != null && Assassin.assassin == PlayerControl.LocalPlayer &&
                       !PlayerControl.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                // CouldUse
                assassinButton.Sprite = Assassin.assassinMarked != null
                    ? Assassin.getKillButtonSprite()
                    : Assassin.getMarkButtonSprite();
                return (Assassin.currentTarget != null || (Assassin.currentTarget != null &&
                                                           !TransportationToolPatches.isUsingTransportation(
                                                               Assassin.assassinMarked))) &&
                       PlayerControl.LocalPlayer.CanMove;
            },
            () =>
            {
