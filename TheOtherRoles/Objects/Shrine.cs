...
public class Shrine
{
    ...
    public Shrine(SystemTypes room, Vector3 pos)
    {
        ...
        List<TaskTypes> taskList = new TaskTypes[0].ToList();
        ...
        button.CachedZ = -0.2f;
        button.OnClick.AddListener((UnityAction)Use);
        List<Console> consoleList = ShipStatus.Instance.AllConsoles.ToList();
