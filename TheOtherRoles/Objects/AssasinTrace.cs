...
internal class AssassinTrace
{
    ...
    public AssassinTrace(Vector2 p, float duration = 1f)
    {
        ...
        SpriteRenderer traceRenderer = trace.AddComponent<SpriteRenderer>();
        ...
        {
            Color c = Palette.PlayerColors[Assassin.assassin.Data.DefaultOutfit.ColorId];
            ...
            Color
                g = Color.green; // Usual display color. could also be Palette.PlayerColors[6] for default grey like camo
