...
namespace TheOtherRoles
{
    ...
    public static class RoleHelpers
    {
        ...
        {
            Patches.Logger.info($"{player?.Data?.PlayerName}({player?.PlayerId}): {Enum.GetName(typeof(RoleType), role)}", "Player.setRole");
            foreach (var t in RoleData.allRoleTypes)
            {
                if (role == t.Key)
                {
        ...
        public static void eraseAllRoles(this PlayerControl player)
        {
            ...
            if (player.isRole(RoleType.Yoyo)) Yoyo.clearAndReload();
        ...
        public static void swapRoles(this PlayerControl player, PlayerControl target)
        {
            ...
            if (player.isRole(RoleType.Yoyo))
            {
                Yoyo.yoyo = target;
