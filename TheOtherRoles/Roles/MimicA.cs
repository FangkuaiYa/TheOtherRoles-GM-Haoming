...
public class MimicA : RoleBase<MimicA>
{
    ...
    public override void OnDeath(PlayerControl killer = null)
    {
        ...
        {
            PlayerControl partner = MimicK.players.FirstOrDefault().player;
        ...
        morphButton = new CustomButton(
            () =>
            {
                if (!isMorph)
                {
                    ...
                    RPCProcedure.mimicMorph(PlayerControl.LocalPlayer.PlayerId,
                        MimicK.allPlayers.FirstOrDefault().PlayerId);
                }
                else
                {
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleType.MimicA) &&
                       PlayerControl.LocalPlayer.isAlive() && MimicK.isAlive();
            },
    ...
    public static class MurderPlayerPatch
    {
        public static void Postfix(PlayerControl __instance, [HarmonyArgument(0)] PlayerControl target)
        {
            ...
            if (__instance.isRole(RoleType.MimicK) && __instance != player && player.isRole(RoleType.MimicA) &&
                player.isAlive()) Helpers.showFlash(new Color(42f / 255f, 187f / 255f, 245f / 255f));
        }
    }
}
