...
public class Sherlock : RoleBase<Sherlock>
{
    ...
    public static TMP_Text numInvestigateText;
    private static CustomButton sherlockWatchButton;
    public static TMP_Text numKillTimerText;
    ...
    public static int numTasks => (int)CustomOptionHolder.sherlockRechargeTasksNumber.getFloat();
    public static int cooldown => (int)CustomOptionHolder.sherlockCooldown.getFloat();
    public static float investigateDistance => CustomOptionHolder.sherlockInvestigateDistance.getFloat();
    ...
    {
        killLog.Add(Tuple.Create(killer.PlayerId,
            Tuple.Create(target.PlayerId, target.transform.position + Vector3.zero)));
    }
    ...
    {
        sherlockInvestigateButton.MaxTimer = cooldown;
    ...
    public static void Clear()
    {
        ...
        numUsed = 0;
        killLog = new List<Tuple<byte, Tuple<byte, Vector3>>>();
    }

    public static Sprite getInvestigateIcon()
    {
        if (investigateIcon) return investigateIcon;
        investigateIcon = TheOtherRolesPlugin.getResources("SherlockInvestigate.png");
    ...
    public static Sprite getWatchIcon()
    {
        ...
        watchIcon = TheOtherRolesPlugin.getResources("SherlockWatch.png");
        return watchIcon;
    }
    ...
    {
        Sherlock p = players.Where(p => p.player == PlayerControl.LocalPlayer).FirstOrDefault();
