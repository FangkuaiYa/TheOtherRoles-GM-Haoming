...
public class Fox : RoleBase<Fox>
{
    ...
    public static bool crewWinsByTasks => CustomOptionHolder.foxCrewWinsByTasks.getBool();
    public static bool impostorWinsBySabotage => CustomOptionHolder.foxImpostorWinsBySabotage.getBool();
    public static float stealthCooldown => CustomOptionHolder.foxStealthCooldown.getFloat();
    public static float stealthDuration => CustomOptionHolder.foxStealthDuration.getFloat();
    public static int numTasks => (int)CustomOptionHolder.foxNumTasks.getFloat();
    public static float stayTime => (int)CustomOptionHolder.foxStayTime.getFloat();
    public static TaskType taskType => (TaskType)CustomOptionHolder.foxTaskType.getSelection();

    public static bool canCreateImmoralist => CustomOptionHolder.foxCanCreateImmoralist.getBool();
    ...
    public static Sprite getHideButtonSprite()
    {
        ...
        hideButtonSprite = TheOtherRolesPlugin.getResources("FoxHideButton.png");
    ...
    public static Sprite getImmoralistButtonSprite()
    {
        ...
        immoralistButtonSprite =
            TheOtherRolesPlugin.getResources("FoxImmoralistButton.png");
    ...
    public static void MakeButtons(HudManager hm)
    {
        ...
        foxButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleType.Fox) &&
        ...
        foxRepairButton = new CustomButton(
            ...
            {
                return PlayerControl.LocalPlayer.isRole(RoleType.Fox) &&
                       PlayerControl.LocalPlayer.isAlive() && numRepair > 0;
            },
            () =>
            {
                bool sabotageActive = false;
        ...
        foxImmoralistButton = new CustomButton(
            ...
            () =>
            {
                return !Immoralist.exists && canCreateImmoralist &&
        ...
        if (updateTimer <= 0.0f)
        {
            ...
            foreach (PlayerControl p in PlayerControl.AllPlayerControls)
            {
                ...
                if (p.Data.Role.IsImpostor || p.isRole(RoleType.Jackal) || p.isRole(RoleType.Sheriff) ||
                    p.isRole(RoleType.JekyllAndHyde) || p.isRole(RoleType.Moriarty) || p.isRole(RoleType.Pelican))
                {
    ...
    {
        bool isAlive = false;
        foreach (PlayerControl fox in allPlayers)
    ...
    public static class PlayerPhysicsFoxPatch
    {
        public static void Postfix(PlayerPhysics __instance)
        {
            ...
            {
                PlayerControl fox = __instance.myPlayer;
