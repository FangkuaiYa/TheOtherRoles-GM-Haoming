...
public class ShipStatusPatch
{
        ...
        [HarmonyArgument(0)] NetworkedPlayerInfo player)
    {
        ...
        {
            float unlerped = Mathf.InverseLerp(__instance.MinLightRadius, __instance.MaxLightRadius,
    ...
    {
        if (CustomOptionHolder.uselessOptions.getBool() && CustomOptionHolder.playerColorRandom.getBool() &&
    ...
    private class ShipStatusStartPatch
    {
        public static void Postfix()
        {
            LogHelper.Info("Game Started", "Phase");
        }
    }
}
