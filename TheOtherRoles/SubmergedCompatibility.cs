...
public static class SubmergedCompatibility
{
    ...
    public static MonoBehaviour SubmarineStatus
    {
        get
        {
            ...
            {
                if (MapUtilities.CachedShipStatus is null || MapUtilities.CachedShipStatus.WasCollected ||
                    !MapUtilities.CachedShipStatus ||
                    MapUtilities.CachedShipStatus == null) return _submarineStatus = null;

                if (MapUtilities.CachedShipStatus.Type == SUBMERGED_MAP_TYPE)
                    return _submarineStatus =
                        MapUtilities.CachedShipStatus.GetComponent(Il2CppType.From(SubmarineStatusType))
    ...
    public static void Initialize()
    {
        ...
        InjectedTypes = (Dictionary<string, Type>)AccessTools
            .PropertyGetter(Types.FirstOrDefault(t => t.Name == "RegisterInIl2CppAttribute"), "RegisteredTypes")
    ...
    {
        if (!Loaded) return;
        MonoBehaviour _floorHandler =
            ((Component)GetFloorHandlerMethod.Invoke(null, new object[] { PlayerControl.LocalPlayer }))
    ...
    public static void RepairOxygen()
    {
        ...
        try
        {
            ...
            RepairDamageMethod.Invoke(SubmarineOxygenSystemInstanceProperty.GetValue(null),
